...
const Video: React.FC = () => {
  return (
    <section id="video" className="py-20 px-6 lg:px-10 bg-gray-50">
      <div className="max-w-5xl mx-auto">
        ...
        <div style={{ position: "relative", overflow: "hidden", padding: "2rem", borderRadius: "1rem", boxShadow: "0 10px 25px -5px rgba(0, 0, 0, 0.1)" }}>
