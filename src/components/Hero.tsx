  ...
  return (
    <section className="hero-gradient min-h-[70vh] flex flex-col items-center justify-center text-center px-6 py-20">
      <div className="space-y-4 max-w-3xl mx-auto">
        <div className="inline-block px-3 py-1 rounded-full bg-red-900/40 text-red-200 text-xs font-medium mb-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10">
          ...
          <Button className="bg-red-600 text-white hover:bg-red-700 border border-white px-8 py-6 text-base rounded-lg">
            View Documentation
          </Button>
        </div>
      </div>
