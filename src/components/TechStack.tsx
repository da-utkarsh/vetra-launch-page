    ...
    <section id="stack" className="py-20 px-6 lg:px-10">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-gray-50 rounded-2xl p-8 flex items-center justify-center">
            <div className="relative w-full max-w-md aspect-square">
              ...
              <div className="absolute inset-0 bg-gray-900 rounded-lg overflow-hidden">
                <pre className="text-xs text-blue-400 p-5 font-mono">
                  <code>
